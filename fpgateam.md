...
|:-----|:---|:-------------------------|
|[山口 佳樹](http://www.cs.tsukuba.ac.jp/~yoshiki/)|教授|<font color="green">リコンフィギャラブルデバイス（FPGA，DAPDNA，DRP，など）とそれを用いたシステム．</font><br>FPGAアーキテクチャから，FPGAを用いたアプリケーションに関する研究までを縦断的に扱っています．既に始まっている半導体を中心とした情報システムの再編のキーワードはチップレットとFPGA．興味を持ったら，研究室紹介で聞いてみましょう．|
